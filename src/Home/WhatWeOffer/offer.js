...
const Offer = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 mt-14 ">
      <h1 className="mb-16   text-center  font-extrabold leading-none tracking-tight">
        <span
          ...
          <div className="relative p-8">
            ...
            <div className="mb-6">
              <div className="relative w-16 h-16 mx-auto transform transition-all duration-500 ease-out group-hover:scale-110">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-primary/30 to-primary/20 rounded-xl transform rotate-0 transition-all duration-500 ease-out group-hover:rotate-[45deg] group-hover:scale-110" />
                
                {/* Icon container */}
                <div className="absolute inset-0 bg-gradient-to-br from-primary to-primary/40 rounded-xl shadow-lg transform transition-all duration-500 ease-out group-hover:rotate-12">
            ...
            <div className="relative z-10 text-center space-y-4">
              <h3 className="text-xl font-semibold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent transform transition-all duration-500 ease-out group-hover:scale-105 group-hover:from-primary group-hover:to-primary">
                {service.title}
              </h3>
